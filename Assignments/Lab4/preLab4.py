...
def task_7():
    ...
    xl = np.array([-9.444, 18.919, 90.289, 18.174, 44.681, -7.578, 52.736])
    yl = np.array([96.236, -81.819, -91.049, 109.538, 7.483, -49.077, -93.140])
    xr = np.array([-105.378, -72.539, -1.405, -77.840, -48.786, -98.814, -38.924])
    yr = np.array([98.756, -79.786, -86.941, 113.375, 10.165, -48.039, -90.035])
